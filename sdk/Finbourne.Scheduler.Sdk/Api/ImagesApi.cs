...
namespace Finbourne.Scheduler.Sdk.Api
{
    ...
    public interface IImagesApiSync : IApiAccessor
    {
        ...
        /// <param name="name">The name and tag of the image of the image. Format \&quot;ExampleImageName:latest,0.1,0.2\&quot;</param>
        ...
        /// <param name="limit">When paginating, limit the number of returned results to this many. Defaults to 2000 if not specified (optional, default to 2000)</param>
    ...
    public partial class ImagesApi : IImagesApi
    {
        ...
        /// <summary>
        /// [EXPERIMENTAL] UploadImage: Uploads an image to be used for Scheduler jobs Every image must have at least one tag
        /// </summary>
        /// <exception cref="Finbourne.Scheduler.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="uploadImageRequest">Request to upload image</param>
        /// <returns>UploadImageInstructions</returns>
