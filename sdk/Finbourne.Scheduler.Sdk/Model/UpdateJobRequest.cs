...
namespace Finbourne.Scheduler.Sdk.Model
{
    ...
    public partial class UpdateJobRequest : IEquatable<UpdateJobRequest>
    {
        ...
        public UpdateJobRequest(string name = default(string), string author = default(string), string description = default(string), string imageName = default(string), string imageTag = default(string), string command = default(string), int ttl = default(int), string minCpu = default(string), string maxCpu = default(string), string minMemory = default(string), string maxMemory = default(string), Dictionary<string, ArgumentDefinition> argumentDefinitions = default(Dictionary<string, ArgumentDefinition>), string commandLineArgumentSeparator = default(string), RequiredResources requiredResources = default(RequiredResources))
        {
            ...
            this.RequiredResources = requiredResources ?? throw new ArgumentNullException("requiredResources is a required property for UpdateJobRequest and cannot be null");
            this.Author = author;
