...
namespace Finbourne.Scheduler.Sdk.Model
{
    ...
    public partial class JobRunResult : IEquatable<JobRunResult>
    {
        ...
        /// <param name="startDate">Start date of the job  Defaults to null if the job has not started yet ( is in a pending status ).</param>
        ...
        /// </summary>
        /// <value>Start date of the job  Defaults to null if the job has not started yet ( is in a pending status )</value>
